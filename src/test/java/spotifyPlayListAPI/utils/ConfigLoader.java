...
public class ConfigLoader {
    ...
    public String getArtist_id() {
        String artist_id = properties.getProperty("single_artist_id");
        if(!(artist_id == null)) return artist_id;
        else throw new RuntimeException("Artist ID is not found in config.properties file");
    }

    public String getSeveralArtist_id() {
        String artist_id = properties.getProperty("multiple_artist_id");
        if(!(artist_id == null)) return artist_id;
        else throw new RuntimeException("Several Artist ID is not found in config.properties file");
    }
}
