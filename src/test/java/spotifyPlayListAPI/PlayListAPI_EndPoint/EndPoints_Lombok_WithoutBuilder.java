...
public class EndPoints_Lombok_WithoutBuilder {
    ...
    public static Response post(PlayList_UsingLombok playList) {
        return ReusableMethods.post(playList, TokenRenew.getToken(), "/users/"+ ConfigLoader.getInstance().getUser_id()+"/playlists");
    }

    public static Response post(PlayList_UsingLombok playList, String token) {
    ...
    public static Response update(PlayList_UsingLombok updatePlayList, String playListId) {
