package spotifyPlayListAPI.PlayListAPI_EndPoint;

import io.restassured.response.Response;
import spotifyPlayListAPI.GenericMethods.ReusableMethods;
import spotifyPlayListAPI.pojo.PlayList_Lombok_BuilderPattern;
import spotifyPlayListAPI.pojo.tokenManager.TokenRenew;
import spotifyPlayListAPI.utils.ConfigLoader;

public class EndPoints_Lombok_WithBuilderPattern {
    ...
    public static Response post(PlayList_Lombok_BuilderPattern playList) {
        return ReusableMethods.post(playList, TokenRenew.getToken(), "/users/"+ ConfigLoader.getInstance().getUser_id()+"/playlists");
    }

    public static Response post(PlayList_Lombok_BuilderPattern playList, String token) {
    ...
    public static Response update(PlayList_Lombok_BuilderPattern updatePlayList, String playListId) {
